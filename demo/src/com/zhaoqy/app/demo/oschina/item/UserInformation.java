 ...
 *
 * @Title: UserInformation.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.oschina.item
 * @Description: 用户专页信息实体类
 * @author: zhaoqy
 * @date: 2015-11-18 下午2:27:07
 * @version: V1.0
 */
...
public class UserInformation extends Entity
{
	...
	public static UserInformation parse(InputStream inputStream) throws IOException
	{
