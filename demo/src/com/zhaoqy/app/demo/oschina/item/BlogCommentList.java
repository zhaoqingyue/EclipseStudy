 ...
 *
 * @Title: BlogCommentList.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.oschina.item
 * @Description: 博客评论列表实体类
 * @author: zhaoqy
 * @date: 2015-11-18 下午4:17:22
 * @version: V1.0
 */
...
public class BlogCommentList extends Entity
{
	...
	public static BlogCommentList parse(InputStream inputStream) throws IOException
	{
