 ...
 *
 * @Title: SoftwareList.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.oschina.item
 * @Description: 软件列表实体类
 * @author: zhaoqy
 * @date: 2015-11-18 下午3:30:43
 * @version: V1.0
 */
...
public class SoftwareList extends Entity
{
	...
	public final static String TAG_CHINA = "list_cn";       //国内
	...
	public static SoftwareList parse(InputStream inputStream) throws IOException
	{
