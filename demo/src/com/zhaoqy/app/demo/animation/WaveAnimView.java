...
public class WaveAnimView extends FrameLayout 
{
    ...
    public WaveAnimView(Context paramContext, AttributeSet paramAttributeSet) 
    {
        super(paramContext, paramAttributeSet);
        init();
    }

    public WaveAnimView(Context paramContext, AttributeSet paramAttributeSet, int paramInt) 
    {
    ...
    private void init() 
    {
        LayoutInflater.from(getContext()).inflate(R.layout.view_sound_wave, this);
    ...
    private void startNext(boolean flag, int index) 
    {
        ...
        {
        	scale = new ScaleAnimation(3.0f, 0.0f, 3.0f, 0.0f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
        }
    ...
    final class WTSearchAnimationHandler implements Animation.AnimationListener 
    {
        ...
        public WTSearchAnimationHandler(WaveAnimView paramImageView, ImageView imageView, int index) 
        {
            mImage = imageView;
            mIndex = index;
        }
