...
public class RefreshListView extends ListView implements OnScrollListener
{
	...
	{
		footerView = LayoutInflater.from(getContext()).inflate(R.layout.view_listview_refresh_footer, null);
	...
	{
		headerView = LayoutInflater.from(getContext()).inflate(R.layout.view_listview_refresh_header, null);
