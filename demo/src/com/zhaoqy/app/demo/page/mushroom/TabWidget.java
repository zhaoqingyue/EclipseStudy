...
public class TabWidget extends LinearLayout 
{
	...
	private void init(final Context context) 
	{
		...
		setBackgroundResource(R.drawable.page_slide_mushroom_index_bottom_bar);
		...
		{
			final int index = i;
			final View view = inflater.inflate(R.layout.view_page_slide_mushroom_tab, null);
			final CheckedTextView itemName = (CheckedTextView) view.findViewById(R.id.item_name);
			itemName.setCompoundDrawablesWithIntrinsicBounds(null, context.getResources().getDrawable(mDrawableIds[i]), null, null);
