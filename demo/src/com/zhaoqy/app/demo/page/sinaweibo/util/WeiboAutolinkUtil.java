package com.zhaoqy.app.demo.page.sinaweibo.util;
...
public class WeiboAutolinkUtil 
{
	public static SpannableString Autolink(String txt, final Context con)
	{
		...
		Pattern pattern = Pattern.compile("@([a-zA-Z0-9_\\-\\u4e00-\\u9fa5]+)|" + "#([^\\#|.]+)#" + "|http://t\\.cn/\\w|" + "\\[(\\S+?)\\]");
		...
		while(matcher.find())
		{
			...
			if(group.startsWith("@"))
			{
				...
				spannableString.setSpan(new ClickableSpan() 
				{
					...
					public void onClick(View widget) 
					{
						...
						Intent in=new Intent(con, SinaWeiboUserInfoActivity.class);
			...
			{
				spannableString.setSpan(new ForegroundColorSpan(0xff0077ff), matcher.start(), matcher.end(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
			}
			else if(group.startsWith("#"))
			{
			}
