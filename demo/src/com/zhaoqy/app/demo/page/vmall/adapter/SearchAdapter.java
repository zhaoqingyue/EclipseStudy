...
public class SearchAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView==null){
			if(lv!=null){
				convertView=View.inflate(context, R.layout.item_vmall_search_list, null);
				vh=new ViewHolder();
				...
				convertView=View.inflate(context, R.layout.item_vmall_search_grid, null);
				vh=new ViewHolder();
		...
		vh.ivpic.setImageResource(R.drawable.vmall_home_icon_no_pic);
