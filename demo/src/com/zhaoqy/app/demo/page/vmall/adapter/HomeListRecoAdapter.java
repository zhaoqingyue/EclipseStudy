...
public class HomeListRecoAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = View.inflate(context, R.layout.item_vmall_reco,
					null);
			vh = new ViewHolder();
		...
		vh.grid_reco_ivprdPic.setContentDescription(list.get(position)
				.getPrdId());
		vh.grid_reco_ivprdPic.setImageResource(R.drawable.vmall_home_icon_no_pic);
