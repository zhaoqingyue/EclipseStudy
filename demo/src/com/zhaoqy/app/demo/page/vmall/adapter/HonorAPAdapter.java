...
public class HonorAPAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = View.inflate(context,R.layout.item_vmall_honor_ap, null);
			vh=new ViewHolder();
		...
		vh.list_activityprds_ivactivityPicUrl.setImageResource(R.drawable.vmall_home_icon_no_pic);
		...
		vh.list_activityprds_ivfittingPicUrl.setImageResource(R.drawable.vmall_home_icon_no_pic);
