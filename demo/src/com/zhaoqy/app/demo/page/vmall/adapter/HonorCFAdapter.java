...
public class HonorCFAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if(convertView==null){
			convertView=View.inflate(context, R.layout.item_vmall_honor_cf, null);
			vh=new ViewHolder();
		...
		vh.grid_commonfitting_ivprdPicUrl.setImageResource(R.drawable.vmall_home_icon_no_pic);
