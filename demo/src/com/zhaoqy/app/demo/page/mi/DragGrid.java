...
public class DragGrid extends GridView 
{
		...
		disappear.setAnimationListener(new Animation.AnimationListener() {
			...
			public void onAnimationEnd(Animation animation) {
				...
				iv_drag.startAnimation(AnimationUtils.loadAnimation(
						getContext(), R.anim.mi_laucher_del_done));
	...
	private void onDrag(int x, int y) {
		if (iv_drag != null) {
			...
			// iv_drag.setPadding((x-mLastX-xtox)+fromView.getLeft()+28-
			// moveNum*Configure.screenWidth,
			// (y-mLastY-ytoy)+fromView.getTop()+(int)(40*Configure.screenDensity)+8,
			// Configure.screenWidth-(x-mLastX-xtox)+fromView.getLeft()+28-
			// moveNum*Configure.screenWidth+16,
			// Configure.screenHeight-((y-mLastY-ytoy)+fromView.getTop()+(int)(40*Configure.screenDensity)+8)-itemHeight+16);
		}
