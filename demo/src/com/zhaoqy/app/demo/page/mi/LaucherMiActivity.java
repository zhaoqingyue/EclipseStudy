package com.zhaoqy.app.demo.page.mi;
...
public class LaucherMiActivity extends Activity implements OnClickListener 
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_page_slide_mi);
		mContext = this;
	...
	private void initView() 
	{
		...
		tv_page.setText("1");
		Configure.init(LaucherMiActivity.this);
	...
	private void initData() 
	{
		...
		mTitle.setText(getResources().getString(R.string.page_slide_item3));
	...
	public LinearLayout addGridView(int i) 
	{
		...
		gridView = new DragGrid(mContext);
		gridView.setAdapter(new DateAdapter(mContext, lists.get(i)));
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2, long arg3) 
			{
				if (lists.get(ii).get(arg2) == null) 
				{
					...
					.setItems(R.array.items, new DialogInterface.OnClickListener() 
					{
						...
						{
							final String[] arrayAddItems = getResources().getStringArray(R.array.items); 
		...
		gridView.setPageListener(new DragGrid.G_PageListener() 
		{
			...
			public void page(int cases, int page) 
			{
				...
				case 0:// 滑动页面
					...
					break;
				case 1:// 删除按钮上来
					//delImage.setBackgroundResource(R.drawable.page_slide_mi_laucher_del);
					//delImage.setVisibility(0);
					//delImage.startAnimation(up);
					break;
				case 2:// 删除按钮变深
					//delImage.setBackgroundResource(R.drawable.page_slide_mi_laucher_del_check);
	...
	{
		down = AnimationUtils.loadAnimation(mContext, R.anim.mi_laucher_del_down);
		up = AnimationUtils.loadAnimation(mContext, R.anim.mi_laucher_del_up);
		...
		right = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT, -1f, Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT, 0f);
		left = new TranslateAnimation(Animation.RELATIVE_TO_PARENT, -1f, Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT, 0f, Animation.RELATIVE_TO_PARENT, 0f);
	...
	{
		Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.mi_laucher_scale_in);
		animation.setAnimationListener(new Animation.AnimationListener() 
		{
			...
			public void onAnimationEnd(Animation animation) 
			{
				...
				tv_page.startAnimation(AnimationUtils.loadAnimation(mContext, R.anim.mi_laucher_scale_out));
			}
		});
