...
public class DateAdapter extends BaseAdapter 
{
	...
	{
		convertView = LayoutInflater.from(context).inflate(R.layout.item_page_slide_mi_laucher_item, null);
		txtAge = (TextView) convertView.findViewById(R.id.txt_userAge);
		if (lstDate.get(position) == null) 
		{
			txtAge.setText("+");
			txtAge.setBackgroundResource(R.drawable.page_slide_mi_laucher_red);
		} 
