package com.zhaoqy.app.demo.notebook.milletnotes.item;

import com.zhaoqy.app.demo.notebook.milletnotes.activity.NotesEditActivity;
import com.zhaoqy.app.demo.notebook.milletnotes.db.Contact;
...
public class NoteItem 
{
    ...
    public NoteItem(Context context, Cursor cursor) 
    {
        ...
        mSnippet = mSnippet.replace(NotesEditActivity.TAG_CHECKED, "").replace(NotesEditActivity.TAG_UNCHECKED, "");
        ...
        {
            mPhoneNumber = DataUtil.getCallNumberByNoteId(context.getContentResolver(), mId);
