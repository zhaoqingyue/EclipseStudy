...
public class NotesHelper extends SQLiteOpenHelper 
{
    ...
    private static NotesHelper mInstance;
    ...
    private static final String CREATE_DATA_TABLE_SQL = "CREATE TABLE " + TABLE.DATA + "(" 
			...
			+ DataColumns.MIME_TYPE + " TEXT NOT NULL," + DataColumns.NOTE_ID + " INTEGER NOT NULL DEFAULT 0,"
    		+ NoteColumns.CREATED_DATE + " INTEGER NOT NULL DEFAULT (strftime('%s','now') * 1000),"
			+ NoteColumns.MODIFIED_DATE + " INTEGER NOT NULL DEFAULT (strftime('%s','now') * 1000),"
			+ DataColumns.CONTENT + " TEXT NOT NULL DEFAULT '',"
			+ DataColumns.DATA1 + " INTEGER," + DataColumns.DATA2 + " INTEGER,"
    ...
    static synchronized NotesHelper getInstance(Context context) 
    {
        if (mInstance == null) 
        {
            mInstance = new NotesHelper(context);
        }
        return mInstance;
    }
