...
import com.zhaoqy.app.demo.notebook.milletnotes.util.ResourceParser.NoteBgResources;
...
public class WorkingNote 
{
	public static final String[] DATA_PROJECTION = new String[] 
	{
		...
		DataColumns.DATA1, 
		DataColumns.DATA2, DataColumns.DATA3,
		DataColumns.DATA4
	};
    ...
    {
        Cursor cursor = mContext.getContentResolver().query(ContentUris.withAppendedId(Notes.CONTENT_NOTE_URI, mNoteId), NOTE_PROJECTION,
        		null, null, null);
        if (cursor != null) 
        {
    ...
    {
        Cursor cursor = mContext.getContentResolver().query(Notes.CONTENT_DATA_URI, DATA_PROJECTION, DataColumns.NOTE_ID + "=?", 
    ...
    {
        if (mIsDeleted || (!existInDatabase() && TextUtils.isEmpty(mContent)) || (existInDatabase() && !mNote.isLocalModified())) 
        {
            return false;
        } 
        else 
