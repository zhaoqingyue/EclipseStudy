package com.zhaoqy.app.demo.notebook.windnotes.dialog;
...
public class WindDialog extends Dialog 
{
    ...
    public WindDialog(Context context, String title, OnColorChangedListener listener) 
    {
    	this(context, Color.TRANSPARENT, title, listener);
    }
    
    public WindDialog(Context context, int initialColor, String title, OnColorChangedListener listener) 
    {
        super(context);
	...
	private class ColorPickerView extends View 
	{
		...
		protected void onDraw(Canvas canvas) 
		{
            ...
            canvas.drawLine(rectLeft - offset, rectTop - offset * 2, rectLeft - offset, rectBottom + offset * 2, mLinePaint);
            canvas.drawLine(rectLeft - offset * 2, rectTop - offset, rectRight + offset * 2, rectTop - offset, mLinePaint);
            canvas.drawLine(rectRight + offset, rectTop - offset * 2, rectRight + offset, rectBottom + offset * 2, mLinePaint);
            canvas.drawLine(rectLeft - offset * 2, rectBottom + offset, rectRight + offset * 2, rectBottom + offset, mLinePaint);
			super.onDraw(canvas);
		}
