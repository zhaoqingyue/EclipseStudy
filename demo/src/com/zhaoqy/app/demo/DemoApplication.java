...
public class DemoApplication extends Application 
{
	...
	public void onCreate() 
	{
		super.onCreate();
		//初始化默认数据
		mDefault_Wallpager = BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_kaixinwang);
		mDefault_TitleWallpager = BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_kaixinwang);
		mDefault_Photo = BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_head_default);
		mDefault_Avatar = PhotoUtil.toRoundCorner(BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_head_default), 15);
	...
	public Bitmap getWallpager(int position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mWallpagersCache.get(wallpagerName);
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("wallpaper/" + wallpagerName));
			mWallpagersCache.put(wallpagerName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
	...
	/**
	 * @Title: getTitleWallpager
	 * @Description: 根据壁纸编号获取标题壁纸
	 * @param position
	 * @return: Bitmap
	 */
	public Bitmap getTitleWallpager(int position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mTitleWallpagersCache.get(titleWallpagerName);
				bitmap = reference.get();
				if (bitmap != null) 
				{
					return bitmap;
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("title_wallpager/" + titleWallpagerName));
			mTitleWallpagersCache.put(titleWallpagerName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
	...
	public Bitmap getHome(String photo) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("home/" + homeName));
			mHomeCache.put(homeName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
			return BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_picture_default);
		}
	}

	/**
	 * @Title: getAvatar
	 * @Description: 根据编号获取用户圆形头像
	 * @param position
	 * @return
	 * @return: Bitmap
	 */
	...
	/**
	 * @Title: getDefaultAvatar
	 * @Description: 根据编号获取用户默认头像
	 * @param position
	 * @return: Bitmap
	 */
	public Bitmap getDefaultAvatar(int position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mDefaultAvatarCache.get(avatarName);
				bitmap = reference.get();
				if (bitmap != null) 
				{
					return bitmap;
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("avatar/" + avatarName));
			mDefaultAvatarCache.put(avatarName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
			return BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_head_default);
		}
	}

	/**
	 * @Title: getPublicPageAvatar
	 * @Description: 根据编号获取公共主页头像
	 * @param position
	 * @return: Bitmap
	 */
	public Bitmap getPublicPageAvatar(int position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mPublicPageAvatarCache.get(avatarName);
				bitmap = reference.get();
				if (bitmap != null) 
				{
					return bitmap;
			...
			bitmap = PhotoUtil.toRoundCorner(BitmapFactory.decodeStream(getAssets().open("publicpage_avatar/" + avatarName)), 15);
			mPublicPageAvatarCache.put(avatarName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
	...
	public Bitmap getPhoto(int position) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("photo/" + photosName));
	...
	public Bitmap getViewed(int position) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("viewed/" + viewedName));
	...
	public Bitmap getViewedHot(int position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mViewedHotCache.get(viewedHotName);
				bitmap = reference.get();
				if (bitmap != null) 
				{
					return bitmap;
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("viewed_hot/" + viewedHotName));
			mViewedHotCache.put(viewedHotName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
	...
	public Bitmap getRecommend(String position) 
	{
		try 
		{
			...
			{
				SoftReference<Bitmap> reference = mRecommendCache.get(recommendName);
				bitmap = reference.get();
				if (bitmap != null) 
				{
					return bitmap;
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("recommend/" + recommendName));
			mRecommendCache.put(recommendName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
	...
	/**
	 * @Title: getNearbyPhoto
	 * @Description: 根据图片名称获取附近照片的图片
	 * @param position
	 * @return: Bitmap
	 */
	public Bitmap getNearbyPhoto(String position) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("nearby_photo/" + nearbyPhotoName));
			mNearbyPhoto.put(nearbyPhotoName, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
			return BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_lbs_checkin_photo_icon);
		}
	}

	/**
	 * @Title: getFaceBitmap
	 * @Description: 根据编号获取表情图片
	 * @param position
	 * @return: Bitmap
	 */
	public Bitmap getFaceBitmap(int position) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeResource(getResources(), mFaces[position]);
	...
	public Bitmap getGift(String gid) 
	{
		try 
		{
			...
			bitmap = BitmapFactory.decodeStream(getAssets().open("gifts/" + gid));
			mGiftsCache.put(gid, new SoftReference<Bitmap>(bitmap));
			return bitmap;
		} 
		catch (Exception e) 
		{
			return BitmapFactory.decodeResource(getResources(), R.drawable.menu_kaixin_gifts_default);
		}
	}

	/**
	 * @Title: getPhoneAlbum
	 * @Description: 根据地址获取手机SD卡图片
	 * @param path
	 * @return: Bitmap
	 */
