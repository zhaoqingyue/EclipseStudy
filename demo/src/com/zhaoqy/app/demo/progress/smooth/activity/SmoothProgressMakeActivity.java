...
import com.zhaoqy.app.demo.progress.smooth.circular.CircularProgressBar;
import com.zhaoqy.app.demo.progress.smooth.circular.CircularProgressDrawable;
import com.zhaoqy.app.demo.progress.smooth.smooth.SmoothProgressBar;

public class SmoothProgressMakeActivity extends Activity implements OnClickListener
{
	...
	public void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_progress_smooth_make);
		mContext = this;
	...
	private void initData() 
	{
        ...
        mSpinnerInterpolators.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, 
	...
	private void updateValues() 
	{
		...
		CircularProgressDrawable.Builder b = new CircularProgressDrawable.Builder(mContext).colors(getResources().getIntArray(R.array.gplus_colors))
				.sweepSpeed(mSpeed).rotationSpeed(mSpeed)
