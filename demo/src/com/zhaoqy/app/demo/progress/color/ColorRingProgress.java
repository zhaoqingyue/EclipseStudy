...
public class ColorRingProgress extends View 
{
    ...
    public ColorRingProgress(Context context, AttributeSet attrs) 
    {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ColorRingProgress, 0, 0);

        try 
        {
            mBgColor = a.getColor(R.styleable.ColorRingProgress_bgColor, 0xffe1e1e1);
            mFgColorEnd = a.getColor(R.styleable.ColorRingProgress_fgColorEnd, 0xffff4800);
            mFgColorStart = a.getColor(R.styleable.ColorRingProgress_fgColorStart, 0xffffe400);
            mPercent = a.getFloat(R.styleable.ColorRingProgress_percent, 75);
            mStartAngle = a.getFloat(R.styleable.ColorRingProgress_startAngle, 0)+270;
            mStrokeWidth = a.getDimensionPixelSize(R.styleable.ColorRingProgress_strokeWidth, dp2px(21));
        }
        finally 
        {
            a.recycle();
