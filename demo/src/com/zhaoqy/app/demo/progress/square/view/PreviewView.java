...
public class PreviewView extends View
{
	...
	public PreviewView(Context context) 
	{
		...
		paintPaint.setColor(context.getResources().getColor(android.R.color.black));
	...
	protected void onDraw(Canvas canvas) 
	{
		...
		canvas.drawText(b ? "32%" : "32", canvas.getWidth()/2, (int) ((canvas.getHeight()/2) - ((paintPaint.descent() + paintPaint.ascent())/2)), paintPaint);
	}
