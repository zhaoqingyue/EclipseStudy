package com.zhaoqy.app.demo.picture.custom.common;
...
public class SVGParser {
     ...
     */
    public static SVG getSVGFromAsset(AssetManager assetMngr, String svgPath) throws IOException {
     ...
     * @throws java.io.IOException       if there was a problem reading the file.
     */
    public static SVG getSVGFromAsset(AssetManager assetMngr, String svgPath, int searchColor, int replaceColor) throws IOException {
        InputStream inputStream = assetMngr.open(svgPath);
