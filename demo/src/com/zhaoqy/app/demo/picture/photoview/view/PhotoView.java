package com.zhaoqy.app.demo.picture.photoview.view;
...
public class PhotoView extends ImageView
{
    ...
    private RotateGesture mRotateDetector;
    ...
    private void init() {
        ...
        mRotateDetector = new RotateGesture(mRotateListener);
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    public InfoUtil getInfo() {
        ...
        return new InfoUtil(rect, local, mImgRect, mWidgetRect, mScale, mDegrees, mScaleType);
    }
     ...
     */
    public void animaFrom(InfoUtil info) {

        if (isInit) {
            reset();

            InfoUtil mine = getInfo();
    ...
    public void animaTo(InfoUtil info, Runnable completeCallBack) {
        if (isInit) {
            mTranslate.stop();
