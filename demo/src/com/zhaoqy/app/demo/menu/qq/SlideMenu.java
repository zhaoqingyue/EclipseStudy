...
public class SlideMenu extends FrameLayout
{
	...
	private List<SlideMenuItem> leftMenuItems;
	private List<SlideMenuItem> rightMenuItems;
	...
	private void initViews(Context context) {
		...
		inflater.inflate(R.layout.view_slide_menu, this);
	...
	private void initValue(Activity activity) {
		...
		leftMenuItems = new ArrayList<SlideMenuItem>();
		rightMenuItems = new ArrayList<SlideMenuItem>();
	...
	public void setShadowVisible(boolean isVisible) {
		if (isVisible)
			imageViewShadow.setImageResource(R.drawable.menu_qq_shadow);
		else
	 ...
	 * @param menuInfo
	 */
	public void addMenuInfo(SlideMenuInfo menuInfo) {
	 ...
	 * @param direction
	 */
	public void addMenuItem(SlideMenuItem menuItem, int direction) {
	 ...
	 * @param direction
	 */
	public void setMenuItems(List<SlideMenuItem> menuItems, int direction) {
		if (direction == DIRECTION_LEFT)
			this.leftMenuItems = menuItems;
		else
	 ...
	 * @return
	 */
	public List<SlideMenuItem> getMenuItems(int direction) {
		if (direction == DIRECTION_LEFT)
			return leftMenuItems;
		else
