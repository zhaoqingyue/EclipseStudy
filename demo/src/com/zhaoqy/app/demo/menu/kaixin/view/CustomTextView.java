 ...
 * @Description: 自定义TextView(添加可以设置drawable大小的功能 )
 * @author: zhaoqy
 * @date: 2015-11-12 下午2:44:08
 * @version: V1.0
 */
    ...
    {  
        ...
        {  
            ...
            {  
                ...
                switch (index) 
                {  
                case R.styleable.textview_bottom_height:  
                    bottomHeight = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_bottom_width:  
                    bottomWidth = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_left_height:  
                    leftHeight = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_left_width:  
                    leftWidth = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_right_height:  
                    rightHeight = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_right_width:  
                    rightWidth = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_top_height:  
                    topHeight = a.getDimensionPixelSize(index, -1);  
                    break;  
                case R.styleable.textview_top_width:  
