 ...
 *
 * @Title: MenuKaixinVoiceActivity.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.menu.kaixin.activity
 * @Description: 录音Activity
 * @author: zhaoqy
 * @date: 2015-11-6 下午1:56:30
 * @version: V1.0
 */
...
import com.zhaoqy.app.demo.menu.kaixin.util.RecordUtil;
...
public class MenuKaixinVoiceActivity extends MenuKaixinBaseActivity 
{
	@SuppressLint("SdCardPath")
	private static final String PATH = "/sdcard/demo/Record/"; // 录音存储路径
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_menu_kaixin_voice);
		mContext = this;
	...
	private void findViewById() 
	{
		...
		mFinish = (TextView) findViewById(R.id.id_title_right_text);
	...
	private void setListener() 
	{
				...
				case MotionEvent.ACTION_UP: //停止录音
				{
					if (mRecord_State == RECORD_ING) 
					{
						...
						else 
						{
							...
							mDisplayVoicePlay.setImageResource(R.drawable.menu_kaixin_voice_player_play);
			...
			public void onClick(View v) 
			{
				...
				if (!mPlayState) 
				{
					...
					try 
					{
						...
						mPlayState = true;
						//修改播放图标
						mDisplayVoicePlay.setImageResource(R.drawable.menu_kaixin_voice_player_stop);
		...
		mPhoto.setOnClickListener(new OnClickListener() 
		{
			public void onClick(View v) 
			{
				...
				startActivityForResult(intent, ActivityForResultUtil.REQUESTCODE_VOICE_DELETE_PHOTO);
			}
		});
	...
	{
		//设置当前的最小声音和最大声音值
		mMINVolume = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4.5f, getResources().getDisplayMetrics());
		mMAXVolume = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 65f, getResources().getDisplayMetrics());
		//获取地理位置数据
		getLocation();
		//显示内容
		mDisplayLocation.setText(mApplication.mMyLocationResults.get(0).getName());
		...
		public void handleMessage(Message msg) 
		{
			...
			case 0:
				if (mRecord_State == RECORD_ING) 
				{
					...
					mRecordLight_1_Animation = AnimationUtils.loadAnimation(mContext, R.anim.menu_kaixin_voice_anim);
			...
			case 1:
				if (mRecord_State == RECORD_ING) 
				{
					...
					mRecordLight_2_Animation = AnimationUtils.loadAnimation(mContext, R.anim.menu_kaixin_voice_anim);
			...
			case 2:
				if (mRecord_State == RECORD_ING)
				{
					...
					mRecordLight_3_Animation = AnimationUtils.loadAnimation(mContext, R.anim.menu_kaixin_voice_anim);
	...
	private void locationDialog() 
	{
		...
		builder.setAdapter(new LocationAdapter(), new DialogInterface.OnClickListener() 
		{
			public void onClick(DialogInterface dialog, int which) 
			{
				...
				mDisplayLocation.setText(mApplication.mMyLocationResults.get(which).getName());
				dialog.dismiss();
			}
		});
	...
	private class LocationAdapter extends BaseAdapter 
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			if (convertView == null) 
			{
				convertView = LayoutInflater.from(mContext).inflate(R.layout.item_menu_kaixin_voice_location, null);
				holder = new ViewHolder();
				holder.icon = (ImageView) convertView.findViewById(R.id.voice_activity_location_item_icon);
				holder.name = (TextView) convertView.findViewById(R.id.voice_activity_location_item_name);
				holder.location = (TextView) convertView.findViewById(R.id.voice_activity_location_item_location);
	...
	private void CompetenceDialog() 
	{
		...
		builder.setAdapter(new CompetenceAdapter(), new DialogInterface.OnClickListener() 
		{
			public void onClick(DialogInterface dialog, int which) 
			{
				...
				mDisplayBottomCompetence.setText(mCompetenceItems[which]);
				dialog.dismiss();
			}
		});
		builder.setNegativeButton("取消", new DialogInterface.OnClickListener() 
	...
	private class CompetenceAdapter extends BaseAdapter 
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			if (convertView == null) 
			{
				convertView = LayoutInflater.from(mContext).inflate(R.layout.item_menu_kaixin_voice_competence, null);
				holder = new ViewHolder();
				holder.icon = (ImageView) convertView.findViewById(R.id.voice_activity_competence_item_icon);
				holder.name = (TextView) convertView.findViewById(R.id.voice_activity_competence_item_name);
				convertView.setTag(holder);
			} 
			else 
			{
