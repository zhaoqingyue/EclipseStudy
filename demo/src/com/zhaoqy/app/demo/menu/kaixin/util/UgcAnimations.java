 ...
 *
 * @Title: UgcAnimations.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.menu.kaixin.util
 * @Description: Path动画类
 * @author: zhaoqy
 * @date: 2015-11-6 上午11:39:15
 * @version: V1.0
 */
...
public class UgcAnimations 
{
	...
	public static void startOpenAnimation(RelativeLayout relativeLayout, ImageView background, ImageView menu, long durationMillis) 
	{
		...
		for (int i = 0; i < relativeLayout.getChildCount(); i++) 
		{
			...
			set.addAnimation(getTranslateAnimation(-params.leftMargin + xOffset, 0f, params.bottomMargin + yOffset, 0f, durationMillis));
	...
	public static void startCloseAnimation(final RelativeLayout relativeLayout, final ImageView background, ImageView menu, long durationMillis) 
	{
		...
		for (int i = 0; i < relativeLayout.getChildCount(); i++) 
		{
			...
			set.addAnimation(getTranslateAnimation(0f, -params.leftMargin+ xOffset, 0f, params.bottomMargin + yOffset, durationMillis));
			set.setFillAfter(true);
			set.setDuration(durationMillis);
