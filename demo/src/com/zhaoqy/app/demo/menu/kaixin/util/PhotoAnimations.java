 ...
 *
 * @Title: PhotoAnimations.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.menu.kaixin.util
 * @Description: 照片动画类
 * @author: zhaoqy
 * @date: 2015-11-6 下午3:10:10
 * @version: V1.0
 */
...
public class PhotoAnimations 
{
	...
	{
		TranslateAnimation translate = new TranslateAnimation(0f, 0f, -top.getHeight(), 0f);
	...
	{
		TranslateAnimation translate = new TranslateAnimation(0f, 0f, 0f, -top.getHeight());
		translate.setDuration(500);
		return translate;
	}
	...
	{
		TranslateAnimation translate = new TranslateAnimation(0f, 0f, bottom.getHeight(), 0f);
		translate.setFillAfter(true);
		translate.setDuration(500);
		return translate;
	}
	...
	{
		TranslateAnimation translate = new TranslateAnimation(0f, 0f, 0f, bottom.getHeight());
		translate.setDuration(500);
		return translate;
	}
	...
	{
		ScaleAnimation scale = new ScaleAnimation(1.0f, 1.0f, 0.0f, 1.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f);
	...
	{
		ScaleAnimation scale = new ScaleAnimation(1.0f, 1.0f, 1.0f, 0.0f, Animation.RELATIVE_TO_SELF, 0.0f, Animation.RELATIVE_TO_SELF,	0.0f);
		scale.setFillAfter(true);
		scale.setDuration(500);
		return scale;
	}
	...
	public static void startOutAnimation(final ViewGroup top, final ViewGroup bottom, final View v) 
	{
	...
	public static void startGoneAnimation(final ViewGroup top, final ViewGroup bottom) 
	{
	...
	public static void startOpenAnimation(ViewGroup parent, ViewGroup more, TextView description, ImageView arrow) 
	{
		...
		arrow.setImageResource(R.drawable.login_more_up);
		more.startAnimation(getOpenAnimation());
	}

	public static void startCloseAnimation(final ViewGroup parent, final ViewGroup more, final TextView description, final ImageView arrow) 
	{
		...
		anim.setAnimationListener(new AnimationListener() 
		{
			...
			public void onAnimationEnd(Animation animation) 
			{
				...
				arrow.setImageResource(R.drawable.login_more_down);
			}
		});
	}
}
