...
import com.zhaoqy.app.demo.menu.kaixin.activity.MenuKaixinImageFilterCropActivity;
	...
	class BackgroundJob implements Runnable {
		...
		public void run() {
				...
				public void run() {
					try {
						mHandler.sendMessage(mHandler
								.obtainMessage(MenuKaixinImageFilterCropActivity.SHOW_PROGRESS));
			...
			try {
				...
				mHandler.sendMessage(mHandler
						.obtainMessage(MenuKaixinImageFilterCropActivity.REMOVE_PROGRESS));
				// mHandler.post(new Runnable()
				// {
				// public void run()
				// {
