 ...
 *
 * @Title: FaceImageView.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.menu.kaixin.view
 * @Description: FaceImageView
 * @author: zhaoqy
 * @date: 2015-11-9 上午10:37:57
 * @version: V1.0
 */
...
public class FaceImageView extends ImageView 
{
	...
	public void addFace(Bitmap face) 
	{
		...
		{
			face = Bitmap.createScaledBitmap(face, mSrc.getHeight(), mSrc.getHeight(), true);
		} 
		else if (mSrc.getHeight() > 100 && mSrc.getWidth() < 100) 
		{
			face = Bitmap.createScaledBitmap(face, mSrc.getWidth(), mSrc.getWidth(), true);
		} 
		else 
		{
