 ...
 *
 * @Title: FriendInfoResult.java
 * @Prject: demo
 * @Package: com.zhaoqy.app.demo.menu.kaixin.item
 * @Description: 好友资料数据的数据实体
 * @author: zhaoqy
 * @date: 2015-11-6 上午10:58:54
 * @version: V1.0
 */
...
public class FriendInfoResult implements Parcelable 
{
	...
	private int gender;           //好友的性别
	private String constellation; //好友的星座
	private String signature;     //好友的签名
	private int photo_count;      //好友的照片个数
	private int diary_count;      //好友的日记个数
	private int friend_count;     //好友的好友个数
	private int visitor_count;    //好友的访问者个数
	private int wallpager;        //好友的背景编号
	private String date;          //好友的生日
