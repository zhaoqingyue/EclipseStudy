...
public class TranslateMenuView extends LinearLayout 
{
	private ListView rbmListView;
	private View rbmOutsideView;
	private TranslateMenuCallback callback;
	private static ArrayList<TranslateMenuItem> menuItems;

	public TranslateMenuView(Context context) 
	{
		super(context);
		load();
	}

	public TranslateMenuView(Context context, AttributeSet attrs) 
	{
		super(context, attrs);
		load();
	}
	...
	private void inflateLayout() 
	{
		try 
		{
			LayoutInflater.from(getContext()).inflate(R.layout.view_menu_translate_menu, this, true);
		} 
		catch (Exception e) 
		{
		}
	...
	private void initUi() 
	{
		...
		rbmListView.setOnItemClickListener(new OnItemClickListener() 
		{
			...
			{
				if (callback != null)
					callback.TranslateMenuItemClick(menuItems.get(position).id);
				hideMenu();
			}
		});
	}

	public void setMenuClickCallback(TranslateMenuCallback callback) 
	{
	...
	{
		menuItems = new ArrayList<TranslateMenuView.TranslateMenuItem>();
		try 
		{
			...
			while (eventType != XmlPullParser.END_DOCUMENT) 
			{
				if (eventType == XmlPullParser.START_TAG) 
				{
					...
					if (elemName.equals("item")) 
					{
						...
						TranslateMenuItem item = new TranslateMenuItem();
	...
	private class Adapter extends BaseAdapter 
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) 
		{
			...
			{
				convertView = inflater.inflate(R.layout.item_menu_translate_item, null);
